...
ys = xu;
gs = Ln;
var zd = { usingClientEntryPoint: !1, Events: [Jt, Un, ol, vs, hs, xu] },
  ht = {
...
const Rd = '/dist/assets/react-35ef61ed.svg',
  Od = '/dist/vite.svg';
function Md() {
  const [e, n] = Tt.useState(0);
  return (
    Tt.useEffect(() => {
      chrome.runtime.onMessage.addListener(({ name: t, data: r }) => {
        t === 'define-word' && console.log(t, r);
      });
    }, []),
    le.jsxs(le.Fragment, {
      children: [
